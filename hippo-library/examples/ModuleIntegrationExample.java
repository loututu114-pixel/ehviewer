...
import com.hippo.library.module.database.DatabaseManager;
import com.hippo.library.module.network.NetworkManager;
import com.hippo.library.module.network.interfaces.INetworkCallback;
import com.hippo.library.module.settings.SettingsManager;
import com.hippo.library.module.notification.NotificationManager;
...
/**
 * 模块集成使用示例
 * 演示如何在实际应用中集成和使用所有Android Library模块
