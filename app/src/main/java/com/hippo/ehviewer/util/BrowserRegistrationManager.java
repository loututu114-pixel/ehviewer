...
public class BrowserRegistrationManager {
    ...
    public boolean forceRegisterBrowser() {
        try {
            ...
            ComponentName webViewComponent = new ComponentName(context, "com.hippo.ehviewer.ui.WebViewActivity");
            ...
            if (enabledState != PackageManager.COMPONENT_ENABLED_STATE_ENABLED) {
                ...
                Log.d(TAG, "WebViewActivity component enabled");
            }
        ...
        try {
            ...
            if (resolveInfo != null && resolveInfo.activityInfo != null) {
                ...
                if (context.getPackageName().equals(packageName) &&
                    "com.hippo.ehviewer.ui.WebViewActivity".equals(activityName)) {
    ...
    public BrowserRegistrationStatus getRegistrationStatus() {
        ...
        try {
            ...
            // 检查Activity状态
            PackageManager pm = context.getPackageManager();
            ComponentName componentName = new ComponentName(context, "com.hippo.ehviewer.ui.WebViewActivity");
