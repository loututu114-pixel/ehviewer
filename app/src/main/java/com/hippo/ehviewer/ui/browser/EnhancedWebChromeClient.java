...
public class EnhancedWebChromeClient extends WebChromeClient {
    ...
    public void onShowCustomView(View view, CustomViewCallback callback) {
        android.util.Log.d(TAG, "onShowCustomView in EnhancedWebChromeClient");
        super.onShowCustomView(view, callback);

        // 如果Activity实现了全屏方法，则调用
        if (mActivity instanceof com.hippo.ehviewer.ui.YCWebViewActivity) {
            ((com.hippo.ehviewer.ui.YCWebViewActivity) mActivity).onShowCustomView(view, callback);
        }
    }

    @Override
    public void onHideCustomView() {
        android.util.Log.d(TAG, "onHideCustomView in EnhancedWebChromeClient");
        super.onHideCustomView();

        // 如果Activity实现了全屏方法，则调用
        if (mActivity instanceof com.hippo.ehviewer.ui.YCWebViewActivity) {
            ((com.hippo.ehviewer.ui.YCWebViewActivity) mActivity).onHideCustomView();
        }
    }
