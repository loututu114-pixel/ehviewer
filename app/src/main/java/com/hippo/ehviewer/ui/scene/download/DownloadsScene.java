...
//        mRecyclerView.setOnGenericMotionListener(this::onGenericMotion);
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        if (id == R.id.action_start_all) {
            ...
            return true;
        } else if (id == R.id.search_download_gallery) {
            Context context = getEHContext();
            if (context == null) {
                return false;
            }
            gotoSearch(context);
            return true;
        } else if (id == R.id.all || id == R.id.sort_by_default || id == R.id.download_done ||
                  id == R.id.not_started || id == R.id.waiting || id == R.id.downloading ||
                  id == R.id.failed || id == R.id.sort_by_gallery_id_asc || id == R.id.sort_by_gallery_id_desc ||
