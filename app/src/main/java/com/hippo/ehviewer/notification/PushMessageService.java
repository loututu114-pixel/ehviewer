...
public class PushMessageService extends FirebaseMessagingService {
    ...
    private void handleUpdateNotification(Map<String, String> data) {
        ...
        Intent updateIntent = new Intent(this, com.hippo.ehviewer.ui.YCWebViewActivity.class);
        updateIntent.putExtra(com.hippo.ehviewer.ui.YCWebViewActivity.EXTRA_URL, updateUrl);
    ...
    private void handleDeepLinkNotification(Map<String, String> data) {
        ...
        Intent deepLinkIntent = new Intent(this, com.hippo.ehviewer.ui.YCWebViewActivity.class);
        deepLinkIntent.putExtra(com.hippo.ehviewer.ui.YCWebViewActivity.EXTRA_URL, deepLink);
