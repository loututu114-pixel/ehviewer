...
public class JumpDateSelector extends LinearLayout implements DatePicker.OnDateChangedListener{
    ...
    private String nodePickerAppendBuild(){
        ...
        String param;
        if (selectId == R.id.jump_1d) {
            param = "1d";
        } else if (selectId == R.id.jump_3d) {
            param = "3d";
        } else if (selectId == R.id.jump_1w) {
            param = "1w";
        } else if (selectId == R.id.jump_2w) {
            param = "2w";
        } else if (selectId == R.id.jump_1m) {
            param = "1m";
        } else if (selectId == R.id.jump_6m) {
            param = "6m";
        } else if (selectId == R.id.jump_1y) {
            param = "1y";
        } else if (selectId == R.id.jump_2y) {
            param = "2y";
        } else {
            param = "1d";
        }
